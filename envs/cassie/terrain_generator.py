...
ROBOT = "cassie scene"
INPUT_SCENE_PATH = "envs/cassie/model/scene.xml"
OUTPUT_SCENE_PATH = "envs/cassie/model/"
...
class TerrainGenerator:
    ...
    def __init__(self, input_path, output_path, scene_name) -> None:
        self.input_path = input_path
        self.output_path = output_path
        self.scene_name = scene_name

        self.output_file = self.output_path + f"{scene_name}.xml"

        self.scene = xml_et.parse(input_path)
    ...
    def AddPerlinHeighField(
        ...
        cv2.imwrite("envs/cassie/model/" + output_hfield_image,
                    terrain_image)
    ...
    def Save(self):
        self.scene.write(self.output_file)


if __name__ == "__main__":
    tg = TerrainGenerator(INPUT_SCENE_PATH, OUTPUT_SCENE_PATH, 'scene_terrain.xml')
